...
class StatusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create status" do
    assert_difference('Status.count') do
      post statuses_url, params: { status: { status_id: @status.status_id, status_type: @status.status_type } }
    end
  ...
  test "should update status" do
    patch status_url(@status), params: { status: { status_id: @status.status_id, status_type: @status.status_type } }
