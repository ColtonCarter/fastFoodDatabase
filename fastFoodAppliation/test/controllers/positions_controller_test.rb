...
class PositionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create position" do
    assert_difference('Position.count') do
      post positions_url, params: { position: { position_id: @position.position_id, position_name: @position.position_name } }
    end
  ...
  test "should update position" do
    patch position_url(@position), params: { position: { position_id: @position.position_id, position_name: @position.position_name } }
